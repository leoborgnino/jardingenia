...
#include <Wire.h>
#include <SeeedOLED.h>
#include "/home/leo/jardingenia/libraries/Planta/Planta.h"
#include "/home/leo/jardingenia/libraries/Planta/Planta.cpp"
...
Planta planta(1,1,1,1,1); // Clase Planta 
...
void setup()
{
 ...
 Serial.begin(BAUD_RATE);  // Monitor general
...
//
//
//    send_uart("ok !",respuestaid_datos);
//    flag_accion = false;
//  }
...
void ISR_Timer ()
{
  ...
  { 
    ...
    flag_bomba_activada = 1;
  }
  else if(planta.cheqHumS()<MAXHUM)
  {
    digitalWrite(Relay, LOW);
    flag_bomba_activada = 0;
  }
...
// Flow Sensor External Interrupt
void sumarPulsos()
{
   NumPulsos++;
}
